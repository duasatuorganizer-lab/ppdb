  ...
  if (currentSettings.requirePinToAccess && !isUnlocked) {
    return (
      <section className="py-12 px-4 max-w-md mx-auto">
        <div className="bg-white rounded-3xl border border-slate-200/90 shadow-2xl p-6 sm:p-8 text-center space-y-5">
          {/* Logo BPICAT on Locked Gate */}
          <div className="flex flex-col items-center">
            <BpicatLogo className="w-24 h-24 shadow-md border-2 border-slate-100 p-1 bg-white hover:scale-105 transition-transform" />
            <div className="inline-flex items-center gap-1.5 mt-3 bg-rose-50 text-rose-800 text-[11px] font-extrabold px-3 py-1 rounded-full border border-rose-200">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-slate-900 tracking-tight">
              Portal Panitia Terproteksi
            </h2>
            <p className="text-slate-500 text-xs mt-1.5 leading-relaxed">
              Sesuai kebijakan privasi, seluruh data pendaftar dan identitas calon siswa <strong className="text-slate-700">hanya dapat dilihat oleh Panitia PPDB SIT At Taufiq</strong>. Silakan masukkan PIN untuk membuka dashboard.
            </p>
          </div>
          ...
          <form onSubmit={handleUnlock} className="space-y-4 text-left">
            ...
            <button
              type="submit"
              className="w-full bg-emerald-700 hover:bg-emerald-800 text-white font-bold py-3 rounded-xl text-xs transition-colors shadow-md cursor-pointer flex items-center justify-center gap-2"
            >
              <ShieldCheck className="w-4 h-4 text-emerald-200" />
              <span>Buka Akses Dashboard Panitia</span>
            </button>
          </form>

          <div className="bg-slate-50 rounded-xl p-3 border border-slate-200 text-[11px] text-slate-500 text-center">
            PIN bawaan panitia: <strong className="text-slate-800 font-mono">123456</strong>
            <span className="block text-[10px] text-slate-400 mt-0.5">(PIN dapat diganti kapan saja di menu Pengaturan)</span>
          </div>
        </div>
      </section>
    );
    ...
    <section className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm">
        <div className="flex items-center gap-3 sm:gap-4">
          <BpicatLogo className="w-14 h-14 sm:w-16 sm:h-16 shadow-md border-2 border-slate-100 p-1 bg-white shrink-0 hover:scale-105 transition-transform" />
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Badan Pengelola Islamic Centre At Taufiq (BPICAT) • Kelola berkas pendaftar, verifikasi keuangan, & kelulusan siswa.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {currentSettings.requirePinToAccess && (
            <button
              ...
              title="Kunci Portal Panitia Sekarang (Logout)"
              className="bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 px-3 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer flex items-center gap-1.5"
            >
